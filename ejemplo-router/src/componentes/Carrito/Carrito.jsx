...
import ContextCarrito from "../../componentes/CarroContext/ContextCarrito";
import styles from "../../componentes/Carrito/";
...
const Carrito = () => {
    ...
    const { ItemCarrito } = useContext(ContextCarrito);
  
    /* Cada vez que se modifica el carrito, actualizamos la cantidad de productos */
    useEffect(() => {
      setProductsLength(
          ItemCarrito?.reduce((previous, current) => previous + current.amount, 0)
      );
    }, [ItemCarrito]);
